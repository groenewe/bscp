...
| `--buffer`                    |          | Push: buffer differing blocks in memory during phase A instead of re-reading them from disk in phase B. Higher memory use, fewer disk reads. Experimental. Auto-disabled if available memory is too low. |
